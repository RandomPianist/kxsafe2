...
<!-- Modal -->
<div class = "modal fade relatorio" id = "relatorioRetiradasModal" aria-labelledby = "relatorioRetiradasModalLabel" aria-hidden = "true">
    <div class = "modal-dialog modal-lg" role = "document">
        <div class = "modal-content">
            <div class = "modal-header d-flex align-items-center">
                <h5 class = "titulo" id = "relatorioRetiradasModalLabel"></h5>
            ...
            <form action = "{{ config('app.root_url') }}/relatorios/retiradas" method = "GET" target = "_blank">
                ...
                <div class = "modal-body">
                    <div class = "container">
                        ...
                        <div class="row mt-3">
                            <div class = "col-12 form-search">
                                <label for = "rel-pessoa2" class = "custom-label-form">Funcionário:</label>
