...
@section("content")
    ...
    <script type = "text/javascript" language = "JavaScript">
        function ir(id) {
            location.href = URL + "/setores/crud/" + id;
        }
        ...
        function listar() {
            $.get(URL + "/setores/listar", {
                ...
                if (data.length) {
                    ...
                    data.forEach((setor) => {
                        resultado += "<tr>" +
                            "<td width = '13%' class = 'text-right'>" + setor.id.toString().padStart(6, "0") + "</td>" +
                            "<td width = '74%'>" + setor.descr + "</td>" +
                            "<td class = 'text-center' width = '13%'>" +
                                "<i class = 'my-icon far fa-edit m-2'  title = 'Editar' onclick = 'ir(" + setor.id + ")'></i>" +
                                "<i class = 'my-icon far fa-trash-alt' title = 'Excluir' onclick = 'excluir(" + setor.id + ", " + '"/setores"' + ", event)'></i>" +
                            "</td>" +
                        "</tr>";
                    });
